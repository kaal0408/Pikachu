...
import KristinaBot.modules.sql.connection_sql as sql
from KristinaBot import dispatcher, DRAGONS, DEV_USERS
from KristinaBot.modules.helper_funcs import chat_status
