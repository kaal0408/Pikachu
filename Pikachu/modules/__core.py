...
from Pikachu import OWNER_ID, DEV_USERS
...
async def Prof(event):
    ...
    the_plugin_file = "./Pikachu/modules/{}.py".format(input_str)
...
from Pikachu.events import load_module
import asyncio
import os
from datetime import datetime
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "Pikachu/modules/",  # pylint:disable=E0602
                )
            )
