...
from KristinaBot import OWNER_ID, DEV_USERS
from KristinaBot import TEMP_DOWNLOAD_DIRECTORY as path
...
async def Prof(event):
    ...
    the_plugin_file = "./KristinaBot/modules/{}.py".format(input_str)
...
from KristinaBot.events import load_module
import asyncio
import os
from datetime import datetime
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "KristinaBot/modules/",  # pylint:disable=E0602
                )
            )
