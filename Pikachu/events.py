...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import Pikachu.events

        path = Path(f"Pikachu/modules/{shortname}.py")
        name = "Pikachu.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Pikachu.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Pikachu/modules/*.py"
